...
Розблокуйте приватний простір, утримуйте застосунок і виберіть **Додати на головний екран** або перетягніть його на головний екран. Приватні застосунки з рядка пропозицій можна додати так само. Натискання відкриває ту саму приватну копію; за потреби пройдіть перевірку Android. Скасування відхиляє запит. Утримуйте піктограму для переміщення, папки або видалення. Інформаційний застосунок модуля можна встановити в приватному просторі як тест без чутливих даних.
...
[Політика конфіденційності (англійською)](../../PRIVACY.md)
