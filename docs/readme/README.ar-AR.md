...
اضغط مطولاً على تطبيق في المساحة الخاصة المفتوحة واختر **إضافة إلى الشاشة الرئيسية**، أو اسحبه مباشرة إلى الشاشة الرئيسية. يعمل هذا أيضاً مع التطبيقات الخاصة في صف الاقتراحات بأعلى قائمة كل التطبيقات. تستخدم الوحدة مواضع Pixel Launcher وقاعدة بياناته وأيقوناته وشارة القفل الأصلية. يُحدَّد الهدف بالرقم التسلسلي للملف الشخصي ومكوّن التشغيل. تدعم النقل والمجلدات والإزالة.
...
**نسخة ألفا تجريبية؛ التحقق على الجهاز غير مكتمل.** يستهدف أجهزة Pixel بنظام Android 15+ (API 35+)، ولكنه **مختبر حالياً على Android 17 فقط** (Pixel 10a، API 37، `CP2A.260805.005`، Pixel Launcher 17). سيحاول المهايئ التحميل على Android 15 و16، إلا أن التحديثات قد تعطل الخطافات الداخلية. نجاح البناء لا يثبت التوافق.
...
افتح المساحة الخاصة، واضغط مطولاً على التطبيق واختر **إضافة إلى الشاشة الرئيسية**، أو اسحبه إلى الشاشة الرئيسية. يمكن أيضاً إضافة التطبيقات الخاصة في صف الاقتراحات بالطريقة نفسها. اضغط الأيقونة لفتح النسخة الخاصة نفسها وصادق عبر Android عند الحاجة. الإلغاء يتخلى عن الطلب. اضغط مطولاً على الأيقونة لنقلها أو وضعها في مجلد أو إزالتها. يمكن تثبيت تطبيق معلومات الوحدة في المساحة الخاصة للاختبار دون بيانات حساسة.
