...
פתחו את המרחב הפרטי, לחצו ארוכות על אפליקציה ובחרו **הוספה למסך הבית**, או גררו אותה למסך הבית. אפשר להוסיף באותו אופן גם אפליקציות פרטיות משורת ההצעות. לחיצה על הסמל פותחת את אותו עותק פרטי; בצעו אימות דרך Android לפי הצורך. ביטול משליך את הבקשה. לחיצה ארוכה מאפשרת הזזה, הכנסה לתיקייה או הסרה. אפשר להתקין את אפליקציית המידע של המודול במרחב הפרטי לבדיקה ללא מידע רגיש.
