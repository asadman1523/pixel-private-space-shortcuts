...
**Deneysel alfa; cihaz doğrulaması tamamlanmadı.** Pixel 10a, Android 17 / API 37, `CP2A.260805.005`, Pixel Launcher 17 (`907`), Magisk, LSPosed 2.2.0 (7854). [Kayıttaki](docs/TESTING.md) APK parmak izi tam eşleşmelidir. Diğer sürümlerde bağdaştırıcı kapanır ve nedeni kaydedilir. Başarılı derleme cihaz uyumluluğunu kanıtlamaz.
...
[Apache-2.0](LICENSE). Google veya LSPosed ile bağlantılı değildir. Google APK’leri, tersine derlenen dosyalar, cihaz günlükleri, kimlik bilgileri ve anahtarlar dağıtılmaz. [Mimari](docs/ARCHITECTURE.md) ve [test kayıtlarına](docs/TESTING.md) bakın.
