...
[Apache-2.0](LICENSE). Nessuna affiliazione con Google o LSPosed. Non distribuiamo APK Google, file decompilati, registri del dispositivo, credenziali o chiavi. Vedi [architettura](docs/ARCHITECTURE.md) e [verifiche](docs/TESTING.md).
